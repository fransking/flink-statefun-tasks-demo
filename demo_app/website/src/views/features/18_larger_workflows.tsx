  ...
  return (
    <div>
      <Feature title="Larg(er) workflows">
        ...
        <br></br><br></br>
        If the results do not need to be ordered performance increases to approximately 79,000 tasks per second.
        </Feature.Blurb>
        <Feature.Code>
{
`
pipeline = generate_noops \\ 
  .send(250000, num_stages=1, ordered=False) \\ 
  .continue_with(count)
...
com.sbbsystems.statefun.tasks.messagehandlers.ResultsBatchHandler
 - Processing results batch of 249,999 messages for pipeline 
   demo/embedded_pipeline/5b45dcd2-e5e6-4555-aa00-6cb2da2dc0aa 
   completed in 14,709 milliseconds

----

com.sbbsystems.statefun.tasks.messagehandlers.ResultsBatchHandler
 - Processing results batch of 249,999 messages for pipeline 
   demo/embedded_pipeline/8b02be1d-0475-46ee-ae4b-9f6af194f023 
   completed in 8,430 milliseconds

----

com.sbbsystems.statefun.tasks.messagehandlers.ResultsBatchHandler
 - Processing results batch of 249,999 messages for pipeline 
   demo/embedded_pipeline/537e12dd-3bab-48d0-a178-5ccc6455ac4a 
   completed in 3,171 milliseconds`
}
        </Feature.Code>
